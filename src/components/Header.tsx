        ...
        <Link href="/" className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center">
              <span className="text-white font-display text-xl font-bold">Z</span>
            </div>
        ...
        <ul className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <li key={link.href}>
              <Link
                href={link.href}
                className={`relative text-sm tracking-wide transition-colors duration-300 hover:text-accent ${
                  pathname === link.href
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <ul className="flex flex-col items-center gap-8">
              {navLinks.map((link, index) => (
                <li
                  key={link.href}
                  className={`text-reveal ${isMenuOpen ? "" : "opacity-0"}`}
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <Link
                    href={link.href}
                    className={`text-2xl font-display tracking-wide transition-colors duration-300 hover:text-accent ${
